...
#todo:
#finish graphing stuff
#toy around with the step bonus idea maybe 50 calories per 5000 steps?
...
def food_dict_get(food,amount): #searches through food dictionary returns string of the item and calories
    try:
